...
try {
    ...
    foreach ($slots as $slot) {
        ...
        echo "<td><a href='#deleteEmployeeModal' class='slot delete btn-line' data-toggle='modal' data-id='" . htmlspecialchars($slot['start_date_slot']) . "'><i class='material-icons' data-toggle='tooltip' title='Delete'>&#xE872;</i></a></td>";
        echo "</tr>";
    }
