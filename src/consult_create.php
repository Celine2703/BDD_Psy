...
$startDate = htmlspecialchars($startDate, ENT_QUOTES, 'UTF-8');  // Nettoyage pour éviter les injections XSS

try {
    $dateTime = new DateTime($startDate);
    $formattedDate = $dateTime->format('Y-m-d\TH:i'); // Format pour datetime-local
} catch (Exception $e) {
    $formattedDate = ''; // Mettre une chaîne vide si la date n'est pas valide
}
?>
    ...
    <form method="post" id="add_task_form" class="needs-validation" novalidate>
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="datetime-local" class="form-control" id="start_date_slot" name="start_date_slot" value="<?php echo $formattedDate; ?>" disabled required>
            </div>
    ...
    $(document).ready(function() {
        $('#add_patient_btn').click(function() {
            ...
            <div class="row mt-2 line-patient">
                <div class="col">
                    <input type="text" class="form-control" name="patient_first_name[]" placeholder="Prénom" required>
                </div>
                <div class="col">
                    <input type="text" class="form-control" name="patient_last_name[]" placeholder="Nom" required>
                </div>
                <div class="col-1">
